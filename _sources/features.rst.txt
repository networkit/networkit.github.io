...
`Degree Distribution <https://github.com/networkit/networkit/blob/master/notebooks/User-Guide.ipynb>`_ Section of the User Guide. The algorithm runs in :math:`O(n)`.
...
usage visit the `Clustering Coefficient <https://github.com/networkit/networkit/blob/master/notebooks/User-Guide.ipynb>`_
...
the `Connected Components <https://github.com/networkit/networkit/blob/master/notebooks/User-Guide.ipynb>`_ Section in the User Guide.
...
in the number of edges. Visit the `Core Decomposition <https://github.com/networkit/networkit/blob/master/notebooks/User-Guide.ipynb>`_
